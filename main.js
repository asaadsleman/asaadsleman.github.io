...
const word_of_the_day = CHOICEWORDS[getRndInteger(0, 50)];
let guesses = [];
...
function load_from_local_storage() {
    ...
    const finished_today = (localStorage.getItem('finished') === 'yes') ||  is_legacy_game_finished;
